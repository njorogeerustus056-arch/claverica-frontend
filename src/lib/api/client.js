...
apiClient.interceptors.request.use(function (config) {
    var _a;
    var token = (_a = auth_1.useAuthStore.getState().tokens) === null || _a === void 0 ? void 0 : _a.access;
    if (token) {
...
apiClient.interceptors.response.use(function (response) { return response; }, function (error) { return __awaiter(void 0, void 0, void 0, function () {
    var originalRequest, refreshed, newToken, refreshError_1;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.trys.push([1, 3, , 4]);
                return [4 /*yield*/, auth_1.useAuthStore.getState().refreshToken()];
            case 2:
                refreshed = _c.sent();
                if (refreshed) {
                    newToken = (_b = auth_1.useAuthStore.getState().tokens) === null || _b === void 0 ? void 0 : _b.access;
