declare module "@mui/icons-material" {
  ...
  // For any other icon, we'll use a catch-all approach
  // This tells TypeScript to allow any string as an export name
  export const __allIcons: { [key: string]: React.ComponentType<any> };
}
