...
function AuthLayout(_a) {
    ...
    return (<div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950">
      ...
      <div className="relative flex flex-col lg:flex-row w-full min-h-screen pt-16">
            ...
            <div className="lg:hidden mb-10 text-center">
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-brand-500 to-brand-600 flex items-center justify-center shadow-lg">
                  <img src="/images/auth/shield-security.svg" alt="Security Shield" className="w-10 h-10 text-white"/>
                </div>
              </div>
              ...
              <div className="flex justify-center mb-8">
                <div className="relative">
                  ...
                  <div className="relative w-24 h-24 rounded-2xl bg-gradient-to-br from-white to-gray-100 dark:from-gray-800 dark:to-gray-900 p-4 shadow-2xl flex items-center justify-center">
                    <img src="/images/auth/shield-security.svg" alt="Bank-Grade Security" className="w-full h-full text-brand-600 dark:text-brand-400"/>
                  </div>
                </div>
              </div>
        ...
        ].map(function (feature, index) { return (<div key={index} className="flex items-center gap-3 p-4 bg-white/5 dark:bg-black/20 rounded-xl backdrop-blur-sm border border-white/10">
                    <div className={"w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center ".concat(feature.color)}>
