...
exports.default = ContactSupport;
...
function ContactSupport() {
    ...
    var contactChannels = [
        {
            ...
            action: function () { return window.open('#chat', '_self'); },
            recommended: true
        },
        {
    ...
    var securityFeatures = [
        { icon: lucide_react_1.Shield, text: 'Bank-level 256-bit encryption' },
        { icon: lucide_react_1.Lock, text: 'SOC 2 Type II certified' },
        { icon: lucide_react_1.Users, text: 'Dedicated fraud prevention team' },
        { icon: lucide_react_1.Award, text: 'FDIC insured through partner banks' }
    ];
    return (<div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-indigo-800 text-white">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <button onClick={function () { return navigate(-1); }} className="flex items-center gap-2 text-blue-200 hover:text-white transition-colors mb-4">
                ← Back to Dashboard
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-xl flex items-center justify-center">
                <lucide_react_1.Shield className="w-6 h-6 text-blue-600"/>
              </div>
              <div>
            ...
            <div className="flex flex-wrap gap-4">
              {securityFeatures.map(function (feature, idx) {
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          {contactChannels.map(function (channel, idx) {
            var Icon = channel.icon;
            return (<div key={idx} className={"relative rounded-2xl p-6 transition-all duration-300 hover:shadow-xl border ".concat(channel.recommended
                    ? 'border-blue-300 bg-gradient-to-br from-blue-50 to-white'
                    : channel.urgent
                        ? 'border-red-200 bg-gradient-to-br from-red-50 to-white'
                        : 'border-gray-200 bg-white')}>
                {channel.recommended && (<div className="absolute -top-2 left-6 bg-blue-500 text-white px-3 py-1 rounded-full text-xs font-medium">
                    Recommended
                  </div>)}
                {channel.urgent && (<div className="absolute -top-2 left-6 bg-red-500 text-white px-3 py-1 rounded-full text-xs font-medium">
                    Urgent Only
                  </div>)}
                
                <div className={"inline-flex p-3 rounded-xl bg-gradient-to-r ".concat(channel.color, " mb-4")}>
                ...
                {channel.contact ? (<a href={channel.action} className="block w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white text-center py-3 rounded-xl font-medium transition-all hover:scale-[1.02]">
                    {channel.contact}
                  </a>) : (<button onClick={channel.action} className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white py-3 rounded-xl font-medium transition-all hover:scale-[1.02]">
                    Start Chat
                  </button>)}
              </div>);
        })}
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-gradient-to-r from-blue-100 to-blue-50 rounded-xl flex items-center justify-center">
                <lucide_react_1.Send className="w-5 h-5 text-blue-600"/>
              </div>
              <div>
            ...
            {submitted ? (<div className="text-center py-12">
                <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
                  <lucide_react_1.CheckCircle2 className="w-10 h-10 text-green-600"/>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input type="text" name="name" value={formData.name} onChange={handleChange} required className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="John Smith"/>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Email Address *
                    </label>
                    <input type="email" name="email" value={formData.email} onChange={handleChange} required className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all" placeholder="john@example.com"/>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <select name="category" value={formData.category} onChange={handleChange} className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                  ...
                  <div>
                    ...
                    <select name="priority" value={formData.priority} onChange={handleChange} className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                ...
                <div>
                  ...
                  <textarea name="message" value={formData.message} onChange={handleChange} required rows={5} className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none" placeholder="Please describe your issue in detail..."></textarea>
                  <p className="text-xs text-gray-500 mt-2">
                    All messages are encrypted end-to-end. Never share your password or PIN.
                  </p>
                </div>

                <button type="submit" className="w-full bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700 hover:to-indigo-800 text-white font-semibold py-4 rounded-xl transition-all hover:scale-[1.02] flex items-center justify-center gap-2 shadow-lg">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 text-white rounded-2xl p-8 shadow-xl">
              <div className="flex items-center gap-3 mb-6">
                <lucide_react_1.Building className="w-6 h-6 text-blue-400"/>
                <h3 className="text-xl font-bold">Corporate Headquarters</h3>
              </div>
              
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <lucide_react_1.MapPin className="w-5 h-5 text-blue-400 mt-1 flex-shrink-0"/>
                  <div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-gradient-to-r from-purple-100 to-purple-50 rounded-xl flex items-center justify-center">
                  <lucide_react_1.CreditCard className="w-5 h-5 text-purple-600"/>
                </div>
                <div>
              ...
              <div className="space-y-4">
                {faqs.map(function (faq, idx) { return (<div key={idx} className="border-b border-gray-100 pb-4 last:border-0">
                    <h4 className="font-semibold text-gray-900 mb-2 flex items-center gap-2">
                      <lucide_react_1.AlertCircle className="w-4 h-4 text-blue-500"/>
                      {faq.question}
                    </h4>
              ...
              <button onClick={function () { return navigate('/help'); }} className="w-full mt-6 py-3 bg-gray-50 hover:bg-gray-100 text-gray-700 rounded-xl font-medium transition-colors flex items-center justify-center gap-2">
