...
import { 
  ...
  DollarSign, Repeat, Phone, Mail, MessageCircle, Handshake,
  RefreshCw, Scale, FileText
} from "lucide-react";
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full shadow-sm text-sm font-semibold text-white mb-6 border border-white/20"
            >
            ...
            {currentServices.map((service, index) => (
              ...
              >
                <div className="relative bg-white rounded-3xl border-2 border-gray-100 p-8 hover:border-blue-200 hover:shadow-2xl transition-all duration-300 h-full flex flex-col">
                  {/* Badge */}
                  {service.badge && (
                    <div className="absolute top-6 right-6 px-3 py-1 bg-gradient-to-r from-blue-500 to-purple-500 text-white text-xs font-bold rounded-full">
                      {service.badge}
                    </div>
                  )}

                  {/* Icon */}
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${service.color} flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform`}>
                    {service.icon}
                  </div>
                  ...
                  <Link
                    to="/signup"
                    className="inline-flex items-center justify-center gap-2 w-full py-3 bg-gray-50 text-gray-900 rounded-xl font-semibold hover:bg-gray-100 transition-colors group"
                  >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-3xl border-2 border-gray-200 p-8 hover:border-blue-300 transition-colors">
              ...
              <Link to="/signup" className="block w-full py-3 bg-gray-100 text-gray-900 rounded-xl font-semibold text-center hover:bg-gray-200 transition-colors">
                Get Started
              </Link>
            </div>
            ...
            <div className="relative bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-8 text-white transform scale-105 shadow-2xl">
              ...
              <Link to="/signup" className="block w-full py-3 bg-white text-blue-600 rounded-xl font-semibold text-center hover:bg-blue-50 transition-colors">
                Upgrade Now
              </Link>
            </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/signup" className="px-10 py-5 bg-white text-blue-600 rounded-2xl font-bold text-lg hover:scale-105 transition-transform shadow-xl">
              Open Free Account
            </Link>
            <Link to="/contact" className="px-10 py-5 bg-white/10 backdrop-blur-sm text-white rounded-2xl font-bold text-lg hover:bg-white/20 transition-colors border-2 border-white/20">
              Talk to Sales
            </Link>
          </div>
        </div>
