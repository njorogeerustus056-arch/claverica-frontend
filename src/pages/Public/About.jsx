...
var STATS = [
    ...
    },
    {
        ...
        icon: <lucide_react_1.Globe className="w-8 h-8"/>,
    ...
    },
    {
        ...
        value: "4.9★",
        label: "User Rating",
        icon: <lucide_react_1.Star className="w-8 h-8"/>,
...
var VALUES = [
    {
        id: "value-1",
        icon: <lucide_react_1.Heart className="w-10 h-10" aria-hidden="true"/>,
    ...
    {
        id: "value-2",
        icon: <lucide_react_1.Shield className="w-10 h-10" aria-hidden="true"/>,
    ...
    {
        id: "value-3",
        icon: <lucide_react_1.Zap className="w-10 h-10" aria-hidden="true"/>,
        title: "Innovation",
    ...
    {
        id: "value-4",
        icon: <lucide_react_1.Globe className="w-10 h-10" aria-hidden="true"/>,
        title: "Global Reach",
...
var PROTECTION_FEATURES = [
    {
        id: "protection-1",
        icon: <lucide_react_1.Lock className="w-10 h-10" aria-hidden="true"/>,
    ...
    {
        id: "protection-2",
        icon: <lucide_react_1.Activity className="w-10 h-10" aria-hidden="true"/>,
    ...
    {
        id: "protection-3",
        icon: <lucide_react_1.Building2 className="w-10 h-10" aria-hidden="true"/>,
    ...
    {
        id: "protection-4",
        icon: <lucide_react_1.Headphones className="w-10 h-10" aria-hidden="true"/>,
...
var INTERACTIVE_FEATURES = [
    ...
    {
        id: "feature-3",
        icon: <lucide_react_1.Globe2 className="w-8 h-8"/>,
    ...
    {
        id: "feature-4",
        icon: <lucide_react_1.ShieldCheck className="w-8 h-8"/>,
...
// Fallback image URL
var FALLBACK_IMAGE = "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop&crop=center";
function AboutUs() {
    var _a = (0, react_1.useState)(0), currentTestimonial = _a[0], setCurrentTestimonial = _a[1];
    var _b = (0, react_1.useState)(true), isTestimonialAutoPlaying = _b[0], setIsTestimonialAutoPlaying = _b[1];
    var _c = (0, react_1.useState)("feature-1"), activeFeature = _c[0], setActiveFeature = _c[1];
    var _d = (0, react_1.useState)(false), videoPlaying = _d[0], setVideoPlaying = _d[1];
    // Memoized computations
    var stats = (0, react_1.useMemo)(function () { return STATS; }, []);
    var values = (0, react_1.useMemo)(function () { return VALUES; }, []);
    var timeline = (0, react_1.useMemo)(function () { return TIMELINE; }, []);
    var protectionFeatures = (0, react_1.useMemo)(function () { return PROTECTION_FEATURES; }, []);
    var interactiveFeatures = (0, react_1.useMemo)(function () { return INTERACTIVE_FEATURES; }, []);
    // Handle testimonial navigation with debouncing
    var nextTestimonial = (0, react_1.useCallback)(function () {
        setCurrentTestimonial(function (prev) { return (prev + 1) % ALL_TESTIMONIALS.length; });
    }, []);
    var prevTestimonial = (0, react_1.useCallback)(function () {
        setCurrentTestimonial(function (prev) { return (prev - 1 + ALL_TESTIMONIALS.length) % ALL_TESTIMONIALS.length; });
    }, []);
    var goToTestimonial = (0, react_1.useCallback)(function (index) {
        setCurrentTestimonial(index);
        setIsTestimonialAutoPlaying(false);
        // Resume auto-play after 10 seconds of inactivity
        setTimeout(function () { return setIsTestimonialAutoPlaying(true); }, 10000);
    }, []);
    ...
    var renderStars = function (count) {
        return Array.from({ length: 5 }, function (_, i) { return (<lucide_react_1.Star key={"star-".concat(i)} className={"w-6 h-6 ".concat(i < count ? 'text-yellow-500 fill-yellow-500' : 'text-gray-300')} aria-hidden="true"/>); });
    };
    // Interactive feature click handler
    var handleFeatureClick = (0, react_1.useCallback)(function (featureId) {
        setActiveFeature(featureId);
        // Simulate action - in real app would navigate or show modal
        console.log("Feature clicked: ".concat(featureId));
    }, []);
    // Video play handler
    var handleVideoPlay = (0, react_1.useCallback)(function () {
    ...
    return (<div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold mb-6 animate-pulse">
                <lucide_react_1.Sparkles className="w-4 h-4" aria-hidden="true"/>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button onClick={function () { return window.location.href = "/signup"; }} className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-bold hover:shadow-2xl transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2" aria-label="Create a ClaveRica account">
                  <lucide_react_1.CheckCircle className="w-5 h-5 group-hover:scale-110 transition-transform" aria-hidden="true"/>
                  Get Started Free
                  <lucide_react_1.ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" aria-hidden="true"/>
                </button>
                
                <button onClick={function () { return handleCTAClick("readBlog"); }} className="group inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-gray-300 text-gray-700 rounded-xl font-bold hover:border-purple-400 hover:text-purple-700 transition-all hover:scale-105 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2" aria-label="Read our latest financial insights">
                  <lucide_react_1.BookOpen className="w-5 h-5" aria-hidden="true"/>
                  Read Insights
                </button>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl group cursor-pointer" onClick={handleVideoPlay}>
                <img src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=600&fit=crop&crop=center" alt="ClaveRica team collaborating in a modern office environment" className="w-full h-auto object-cover group-hover:scale-105 transition-transform duration-700" width={800} height={600} loading="lazy" onError={handleImageError}/>
                <div className="absolute inset-0 bg-gradient-to-t from-black/40 to-transparent" aria-hidden="true"/>
                
                {!videoPlaying && (<div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-20 h-20 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center group-hover:scale-110 transition-transform">
                      <lucide_react_1.PlayCircle className="w-10 h-10 text-blue-600" aria-hidden="true"/>
                    </div>
                  </div>)}
              </div>
              ...
              <div className="absolute -bottom-8 -left-8 bg-white rounded-2xl p-6 shadow-2xl border border-gray-200 hover:shadow-3xl transition-all hover:-translate-y-1 cursor-pointer group">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-green-400 to-emerald-600 flex items-center justify-center group-hover:scale-110 transition-transform">
                    <lucide_react_1.CheckCircle className="w-7 h-7 text-white"/>
                  </div>
                  <div>
      ...
      <section className="py-16 bg-gradient-to-r from-gray-900 via-blue-900 to-purple-900 text-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map(function (stat) { return (<div key={stat.id} className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-white/20 hover:bg-white/10 transition-all hover:scale-105 cursor-pointer group" onClick={function () { return console.log("Clicked stat: ".concat(stat.label)); }}>
                <div className="flex items-center justify-between mb-4">
                  ...
                  {stat.trend && (<span className="text-xs font-semibold px-2 py-1 rounded-full bg-emerald-500/20 text-emerald-300">
                      {stat.trend}
                    </span>)}
                </div>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {interactiveFeatures.map(function (feature) { return (<button key={feature.id} onClick={function () { return handleFeatureClick(feature.id); }} className={"bg-white rounded-xl p-6 border-2 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ".concat(activeFeature === feature.id
                ? 'border-blue-500 shadow-lg'
                : 'border-gray-200 hover:border-blue-300')} aria-label={"Learn about ".concat(feature.title)}>
                <div className={"w-12 h-12 rounded-lg flex items-center justify-center mb-4 ".concat(activeFeature === feature.id
                ...
                <span className={"inline-flex items-center gap-1 text-sm font-medium ".concat(activeFeature === feature.id
                ? 'text-blue-600'
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-8 text-white shadow-2xl hover:shadow-3xl transition-shadow">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between border-b border-white/20 pb-4 hover:border-white/40 transition-colors">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex">
                        {__spreadArray([], Array(5), true).map(function (_, i) { return (<lucide_react_1.Star key={i} className="w-4 h-4 text-yellow-300 fill-yellow-300"/>); })}
                      </div>
                    </div>
                  </div>
                ...
                <button onClick={function () { return handleCTAClick("comparePlans"); }} className="mt-8 w-full py-3 bg-white/20 backdrop-blur-sm rounded-xl text-center hover:bg-white/30 transition-colors font-semibold">
                  Compare Plans →
                </button>
              </div>
            </div>
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map(function (value) { return (<div key={value.id} className="group bg-white rounded-3xl p-8 hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border border-gray-200 hover:border-transparent cursor-pointer focus-within:ring-2 focus-within:ring-blue-500 focus-within:ring-offset-2">
                <div className={"w-20 h-20 rounded-2xl ".concat(value.gradient, " flex items-center justify-center text-white mb-6 transform group-hover:scale-110 group-hover:rotate-12 transition-all duration-500")}>
                  {value.icon}
                </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {timeline.map(function (item, idx) { return (<div key={item.id} className={"flex items-center gap-8 ".concat(idx % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse')}>
                  <div className={"flex-1 ".concat(idx % 2 === 0 ? 'md:text-right' : 'md:text-left')}>
                    <button className="inline-block bg-white border-2 border-gray-200 rounded-2xl p-6 hover:shadow-xl transition-all hover:scale-105 hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 text-left w-full group" onClick={function () { return console.log("Clicked milestone: ".concat(item.year, " - ").concat(item.title)); }}>
                  ...
                  <div className="hidden md:block w-8 h-8 rounded-full bg-gradient-to-br from-blue-600 to-purple-600 border-4 border-white shadow-lg relative z-10 hover:scale-125 transition-transform cursor-pointer" aria-hidden="true" onClick={function () { return console.log("Timeline point: ".concat(item.year)); }}/>
      ...
      <section className="py-24 px-6 bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {protectionFeatures.map(function (feature) { return (<button key={feature.id} className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700 hover:border-cyan-500 transition-all hover:scale-105 hover:shadow-2xl focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-900 group" onClick={function () { return console.log("Security feature: ".concat(feature.title)); }} aria-label={"Learn about ".concat(feature.title)}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl border border-gray-200 hover:shadow-3xl transition-shadow">
              <div className="flex items-center gap-1 mb-6" aria-label={"Rating: ".concat(ALL_TESTIMONIALS[currentTestimonial].stars, " out of 5 stars")}>
              ...
              <div className="flex items-center justify-between">
                <button className="flex items-center gap-4 group" onClick={function () { return console.log("View ".concat(ALL_TESTIMONIALS[currentTestimonial].name, "'s story")); }}>
                  <img src={ALL_TESTIMONIALS[currentTestimonial].photo} alt={"Portrait of ".concat(ALL_TESTIMONIALS[currentTestimonial].name)} className="w-16 h-16 rounded-full object-cover border-4 border-blue-100 group-hover:border-blue-300 transition-colors" width={64} height={64} loading="lazy" onError={handleImageError}/>
                ...
                <div className="flex gap-2" role="tablist" aria-label="Testimonial navigation">
                  {ALL_TESTIMONIALS.map(function (_, idx) { return (<button key={"indicator-".concat(idx)} onClick={function () { return goToTestimonial(idx); }} className={"w-3 h-3 rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ".concat(idx === currentTestimonial
                ? 'bg-gradient-to-r from-blue-600 to-purple-600 w-8'
                : 'bg-gray-300 hover:bg-gray-400')} role="tab" aria-selected={idx === currentTestimonial} aria-label={"View testimonial ".concat(idx + 1, " of ").concat(ALL_TESTIMONIALS.length)} tabIndex={0}/>); })}
                </div>
              </div>
            </div>

            {/* Navigation arrows */}
            <button onClick={prevTestimonial} className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 w-12 h-12 bg-white rounded-full shadow-xl flex items-center justify-center hover:scale-110 transition-transform border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 md:translate-x-0 md:-translate-x-12 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50" aria-label="Previous testimonial">
              <lucide_react_1.ChevronLeft className="w-6 h-6 text-gray-900" aria-hidden="true"/>
            </button>
            <button onClick={nextTestimonial} className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 w-12 h-12 bg-white rounded-full shadow-xl flex items-center justify-center hover:scale-110 transition-transform border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 md:translate-x-0 md:translate-x-12 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50" aria-label="Next testimonial">
              <lucide_react_1.ChevronRight className="w-6 h-6 text-gray-900" aria-hidden="true"/>
            </button>
          </div>
      ...
      <section id="join" className="py-32 px-6 bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <button onClick={function () { return window.location.href = "/signup"; }} className="group inline-flex items-center justify-center gap-2 px-10 py-5 bg-white text-gray-900 rounded-2xl font-bold text-lg hover:scale-105 transition-all shadow-2xl hover:shadow-3xl focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-900" aria-label="Create a free ClaveRica account">
              <lucide_react_1.CheckCircle className="w-6 h-6" aria-hidden="true"/>
              Create Free Account
              <lucide_react_1.ArrowRight className="w-6 h-6 group-hover:translate-x-2 transition-transform" aria-hidden="true"/>
            </button>
            
            <button onClick={function () { return handleCTAClick("comparePlans"); }} className="group inline-flex items-center justify-center gap-2 px-10 py-5 bg-white/10 backdrop-blur-sm text-white rounded-2xl font-bold text-lg hover:bg-white/20 transition border-2 border-white/20 hover:border-white/40 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-900" aria-label="Compare our plans">
              Compare Plans
            </button>
          </div>
