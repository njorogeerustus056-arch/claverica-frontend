...
var ThemeToggleButton_1 = require("../common/ThemeToggleButton");
var NotificationDropdown_1 = require("./NotificationDropdown");
var UserDropdown_1 = require("./UserDropdown");
var react_router_1 = require("react-router");
var Header = function (_a) {
    var onClick = _a.onClick, onToggle = _a.onToggle;
    var _b = (0, react_1.useState)(false), isApplicationMenuOpen = _b[0], setApplicationMenuOpen = _b[1];
    var toggleApplicationMenu = function () {
        setApplicationMenuOpen(!isApplicationMenuOpen);
    };
    return (<header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <button onClick={onClick} className="items-center justify-center hidden w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-99999 dark:border-gray-800 lg:flex dark:text-gray-400 lg:h-11 lg:w-11 lg:border">
          ...
          <react_router_1.Link to="/" className="lg:hidden">
        ...
        <div className={"".concat(isApplicationMenuOpen ? "flex" : "hidden", " items-center justify-between w-full gap-4 px-5 py-4 lg:flex shadow-theme-md lg:justify-end lg:px-0 lg:shadow-none")}>
          <div className="flex items-center gap-2 2xsm:gap-3">
            {/* <!-- Dark Mode Toggler --> */}
            <ThemeToggleButton_1.ThemeToggleButton />
            {/* <!-- Dark Mode Toggler --> */}
            <NotificationDropdown_1.default />
            {/* <!-- Notification Menu Area --> */}
          </div>
          {/* <!-- User Area --> */}
          <UserDropdown_1.default />
        </div>
      </div>
    </header>);
};
