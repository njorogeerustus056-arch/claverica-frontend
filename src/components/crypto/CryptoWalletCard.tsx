...
import { QrCode, Copy, Check, Send, Download, Eye, EyeOff, AlertCircle, ChevronRight, TrendingUp, TrendingDown, Sparkles, Lock, ArrowUpRight, Info, Star } from 'lucide-react';
    ...
    <div 
      className={`group relative bg-white dark:bg-slate-900 rounded-3xl overflow-hidden transition-all duration-500 hover:shadow-2xl ${
        requiresKYC 
          ...
          : 'ring-1 ring-slate-200 dark:ring-slate-800 hover:ring-blue-500/30'
      }`}
    ...
    >
      ...
      <div className="relative p-6">
        ...
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              <div className={`relative w-16 h-16 rounded-2xl flex items-center justify-center text-3xl shadow-2xl transition-all duration-500 ${
          ...
          {/* Price Change Badge */}
          <div className={`flex items-center gap-1.5 px-3.5 py-2 rounded-full text-xs font-bold shadow-lg transition-all duration-300 backdrop-blur-sm ${
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-3 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700/50 group/address hover:border-slate-300 dark:hover:border-slate-600 transition-all">
              ...
              <button
                ...
                className="group/copy flex items-center gap-2 p-2.5 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-blue-400 dark:hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all duration-300 hover:scale-105 active:scale-95"
              >
                {copiedAddress === coin.walletAddress ? (
                  ...
                  <>
                    <Copy className="w-4 h-4 text-slate-600 dark:text-slate-400 group-hover/copy:text-blue-600 dark:group-hover/copy:text-blue-400" />
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          <button 
            onClick={onBuy}
            className={`group/btn relative px-4 py-4 rounded-2xl font-bold text-sm transition-all duration-300 flex flex-col items-center justify-center gap-2 overflow-hidden hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl ${
              requiresKYC
          ...
          <button 
            ...
            className="group/btn relative px-4 py-4 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 border-2 border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 text-slate-800 dark:text-white rounded-2xl font-bold text-sm transition-all duration-300 flex flex-col items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98] shadow-sm hover:shadow-md"
          >
            <Eye className="w-5 h-5 transition-transform duration-300 group-hover/btn:scale-110" strokeWidth={2.5} />
