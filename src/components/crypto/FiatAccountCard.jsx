...
exports.FiatAccountCard = void 0;
// src/components/crypto/FiatAccountCard.tsx
var lucide_react_1 = require("lucide-react");
var react_1 = require("react");
var FiatAccountCard = function (_a) {
    var platform = _a.platform, showBalances = _a.showBalances, onAddFunds = _a.onAddFunds, onTransfer = _a.onTransfer, user = _a.user, kycThreshold = _a.kycThreshold;
    var requiresKYC = !(user === null || user === void 0 ? void 0 : user.is_verified) && platform.balance > kycThreshold;
    ...
    var currencySymbol = platform.currency === 'USD' ? '$' :
    ...
    var gradientColor = currencyColors[platform.currency] || 'from-slate-500 to-slate-600';
    return (<div className={"group relative bg-white dark:bg-slate-900 rounded-3xl overflow-hidden transition-all duration-500 hover:shadow-2xl ".concat(requiresKYC
            ...
            : 'ring-1 ring-slate-200 dark:ring-slate-800 hover:ring-blue-500/20')} onMouseEnter={function () { return setIsHovered(true); }} onMouseLeave={function () { return setIsHovered(false); }}>
      ...
      <div className="relative p-6">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="relative">
            <div className={"absolute inset-0 rounded-2xl blur-xl opacity-60 transition-all duration-500 ".concat(isHovered ? 'scale-110' : 'scale-100', " bg-gradient-to-br ").concat(gradientColor)}/>
            
            <div className={"relative w-14 h-14 rounded-2xl flex items-center justify-center text-2xl shadow-xl transition-all duration-500 ".concat(isHovered ? 'scale-110 rotate-3' : 'scale-100 rotate-0', " bg-gradient-to-br ").concat(gradientColor)}>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className={"text-xs px-2.5 py-1 rounded-full font-bold ".concat(platform.type === 'bank'
          ...
          <div className="relative p-6 bg-gradient-to-br from-slate-50 to-slate-100/50 dark:from-slate-800/80 dark:to-slate-800/40 rounded-2xl border border-slate-200/50 dark:border-slate-700/50 backdrop-blur-sm overflow-hidden">
            ...
            <div className="relative">
              <p className="text-4xl font-bold text-slate-900 dark:text-white tracking-tight tabular-nums mb-2">
                {showBalances
            ? "".concat(currencySymbol).concat(platform.balance.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }))
            : '••••••'}
              </p>
              
              <div className="flex items-center gap-2">
                <lucide_react_1.CheckCircle className="w-4 h-4 text-emerald-600 dark:text-emerald-400"/>
            ...
            {requiresKYC && (<div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-teal-100 dark:bg-teal-900/30 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <lucide_react_1.TrendingUp className="w-3.5 h-3.5 text-teal-600 dark:text-teal-400"/>
                  </div>
                  <div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          ...
          <div className="p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700/50">
            <div className="flex items-center gap-2 mb-2">
              <lucide_react_1.Shield className="w-4 h-4 text-slate-500 dark:text-slate-400"/>
        ...
        {/* Action Buttons */}
        <div className="grid grid-cols-2 gap-3 mb-6">
          <button onClick={onAddFunds} className={"group/btn relative px-4 py-4 rounded-2xl font-bold text-sm transition-all duration-300 flex items-center justify-center gap-2 overflow-hidden hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl ".concat(requiresKYC
        ...
        <div className="border-t border-slate-200 dark:border-slate-800 pt-4">
          ...
          {showDetails && (<div className="space-y-3 animate-in slide-in-from-top-2">
              ...
              {platform.accountNumber && (<div className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-200 dark:border-slate-700/50">
...
exports.FiatAccountCard = FiatAccountCard;
