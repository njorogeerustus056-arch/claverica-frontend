...
function UserMetaCard() {
    var _a = (0, useModal_1.useModal)(), isOpen = _a.isOpen, openModal = _a.openModal, closeModal = _a.closeModal;
    ...
    return (<>
      ...
      <modal_1.Modal isOpen={isOpen} onClose={closeModal} className="max-w-[700px] m-4">
            ...
            <div className="custom-scrollbar h-[450px] overflow-y-auto px-2 pb-3">
              <div>
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div>
                    <Label_1.default>Facebook</Label_1.default>
                    <InputField_1.default type="text" value="https://www.facebook.com/PimjoHQ"/>
                  </div>

                  <div>
                    <Label_1.default>X.com</Label_1.default>
                    <InputField_1.default type="text" value="https://x.com/PimjoHQ"/>
                  </div>

                  <div>
                    <Label_1.default>Linkedin</Label_1.default>
                    <InputField_1.default type="text" value="https://www.linkedin.com/company/pimjo"/>
                  </div>

                  <div>
                    <Label_1.default>Instagram</Label_1.default>
                    <InputField_1.default type="text" value="https://instagram.com/PimjoHQ"/>
                  </div>
                </div>
              </div>
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div className="col-span-2 lg:col-span-1">
                    <Label_1.default>First Name</Label_1.default>
                    <InputField_1.default type="text" value="Musharof"/>
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label_1.default>Last Name</Label_1.default>
                    <InputField_1.default type="text" value="Chowdhury"/>
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label_1.default>Email Address</Label_1.default>
                    <InputField_1.default type="text" value="randomuser@pimjo.com"/>
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label_1.default>Phone</Label_1.default>
                    <InputField_1.default type="text" value="+09 363 398 46"/>
                  </div>

                  <div className="col-span-2">
                    <Label_1.default>Bio</Label_1.default>
                    <InputField_1.default type="text" value="Team Manager"/>
                  </div>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
              <Button_1.default size="sm" variant="outline" onClick={closeModal}>
                Close
              </Button_1.default>
              <Button_1.default size="sm" onClick={handleSave}>
                Save Changes
              </Button_1.default>
            </div>
          </form>
