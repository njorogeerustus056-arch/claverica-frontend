...
exports.default = KycStatus;
var lucide_react_1 = require("lucide-react");
function KycStatus(_a) {
    var status = _a.status, estimatedTime = _a.estimatedTime;
        ...
        switch (status) {
            case "submitted":
                return {
                    ...
                    icon: <lucide_react_1.FileCheck className="w-8 h-8"/>,
                    color: "text-blue-400",
            ...
            case "verifying":
                return {
                    ...
                    icon: <lucide_react_1.Loader2 className="w-8 h-8 animate-spin"/>,
            ...
            case "approved":
                return {
                    ...
                    icon: <lucide_react_1.CheckCircle2 className="w-8 h-8"/>,
            ...
            case "rejected":
                return {
                    ...
                    icon: <lucide_react_1.AlertCircle className="w-8 h-8"/>,
                    color: "text-red-400",
    ...
    return (<div className="space-y-8">
      {/* Status Banner */}
      <div className={"bg-gradient-to-r ".concat(statusConfig.gradient, "/10 rounded-2xl p-8 border ").concat(statusConfig.borderColor)}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-6">
            <div className={"w-20 h-20 rounded-2xl ".concat(statusConfig.bgColor, " flex items-center justify-center border ").concat(statusConfig.borderColor)}>
              <div className={statusConfig.color}>
                {statusConfig.icon}
              </div>
            </div>
            <div>
              <h3 className={"text-3xl font-bold ".concat(statusConfig.color, " mb-2")}>
                {statusConfig.title}
              </h3>
          ...
          {status === "approved" && (<div className="text-right">
      ...
      <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-8 border border-white/10">
        ...
        <div className="relative">
          ...
          <div className="absolute left-6 top-0 bottom-0 w-0.5 bg-white/10">
            <div className="absolute top-0 left-0 w-full bg-gradient-to-b from-blue-500 to-cyan-500 transition-all duration-1000" style={{
          ...
          <div className="space-y-8">
            {verificationSteps.map(function (step, index) { return (<div key={step.id} className="relative pl-16">
                {/* Step Icon */}
                ...
                : step.status === "current"
                  ...
                  {step.status === "completed" ? (<lucide_react_1.CheckCircle2 className="w-6 h-6 text-white"/>) : step.status === "current" ? (<lucide_react_1.Loader2 className="w-6 h-6 text-white animate-spin"/>) : (<div className="w-6 h-6 text-gray-400">{step.id}</div>)}
                </div>
                ...
                : step.status === "current"
                  ...
                  {step.status === "current" && (<div className="mt-4">
                      <div className="flex items-center gap-2 mb-2">
                        <lucide_react_1.Loader2 className="w-4 h-4 text-blue-400 animate-spin"/>
        ...
        {status === "approved" ? (<>
            <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-2xl p-6 border border-green-500/20">
              <div className="flex items-center gap-3 mb-4">
                <lucide_react_1.UserCheck className="w-6 h-6 text-green-400"/>
            ...
            <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-2xl p-6 border border-blue-500/20">
              <div className="flex items-center gap-3 mb-4">
                <lucide_react_1.Shield className="w-6 h-6 text-blue-400"/>
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-2xl p-6 border border-purple-500/20">
              <div className="flex items-center gap-3 mb-4">
                <lucide_react_1.CheckCircle2 className="w-6 h-6 text-purple-400"/>
            ...
            <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 rounded-2xl p-6 border border-amber-500/20">
              <div className="flex items-center gap-3 mb-4">
                <lucide_react_1.Clock className="w-6 h-6 text-amber-400"/>
            ...
            <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-2xl p-6 border border-blue-500/20">
              <div className="flex items-center gap-3 mb-4">
                <lucide_react_1.FileCheck className="w-6 h-6 text-blue-400"/>
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-2xl p-6 border border-green-500/20">
              <div className="flex items-center gap-3 mb-4">
                <lucide_react_1.CheckCircle2 className="w-6 h-6 text-green-400"/>
            ...
            <div className="bg-gradient-to-br from-red-500/10 to-rose-500/10 rounded-2xl p-6 border border-red-500/20">
              <div className="flex items-center gap-3 mb-4">
                <lucide_react_1.AlertCircle className="w-6 h-6 text-red-400"/>
            ...
            <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 rounded-2xl p-6 border border-amber-500/20">
              <div className="flex items-center gap-3 mb-4">
                <lucide_react_1.FileCheck className="w-6 h-6 text-amber-400"/>
            ...
            <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-2xl p-6 border border-blue-500/20">
              <div className="flex items-center gap-3 mb-4">
                <lucide_react_1.Clock className="w-6 h-6 text-blue-400"/>
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-2xl p-6 border border-purple-500/20">
              <div className="flex items-center gap-3 mb-4">
                <lucide_react_1.Shield className="w-6 h-6 text-purple-400"/>
