...
function MonthlyTarget() {
    ...
    return (<div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/3">
      <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
        ...
        <div className="relative ">
          <div className="max-h-[330px]" id="chartDarkStyle">
            <react_apexcharts_1.default options={options} series={series} type="radialBar" height={330}/>
          </div>
