...
function RecentOrders() {
    return (<div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-4 pb-3 pt-4 dark:border-gray-800 dark:bg-white/3 sm:px-6">
      ...
      <div className="max-w-full overflow-x-auto">
        <table_1.Table>
          {/* Table Header */}
          <table_1.TableHeader className="border-gray-100 dark:border-gray-800 border-y">
            <table_1.TableRow>
              <table_1.TableCell isHeader className="py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">
                Products
              </table_1.TableCell>
              <table_1.TableCell isHeader className="py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">
                Category
          ...
          <table_1.TableBody className="divide-y divide-gray-100 dark:divide-gray-800">
            {tableData.map(function (product) { return (<table_1.TableRow key={product.id} className="">
                <table_1.TableCell className="py-3">
                  <div className="flex items-center gap-3">
                ...
                <table_1.TableCell className="py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                  {product.price}
                </table_1.TableCell>
                <table_1.TableCell className="py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                  {product.category}
                ...
                <table_1.TableCell className="py-3 text-gray-500 text-theme-sm dark:text-gray-400">
                  <Badge_1.default size="sm" color={product.status === "Delivered"
                ? "success"
